def policy_pcv_rebalancing(params, substep, state_history, previous_state):
    ...
    if (
        ...
        stable_asset_target_value_change = (
            stable_allocation_pct_change * total_pcv_value
        )
        ...
        volatile_asset_target_value_change = (
            volatile_allocation_pct_change * total_pcv_value
        )
...
def update_total_stable_asset_pcv_amount(
    ...
    total_stable_asset_pcv_amount = (
        previous_state["total_stable_asset_pcv_amount"] + target_amount_change
    )

    return "total_stable_asset_pcv_amount", total_stable_asset_pcv_amount


def update_total_volatile_asset_pcv_amount(
    params, substep, state_history, previous_state, policy_input
):
    """
    ...
    total_volatile_asset_pcv_amount = (
        previous_state["total_volatile_asset_pcv_amount"] + target_amount_change
    )

    return "total_volatile_asset_pcv_amount", total_volatile_asset_pcv_amount


def update_total_stable_asset_pcv_value(
    params, substep, state_history, previous_state, policy_input
):
    """
...
def update_total_volatile_asset_pcv_value(
    params, substep, state_history, previous_state, policy_input
):
    """
    ...
    total_volatile_asset_pcv_value = (
        total_volatile_asset_pcv_amount * volatile_asset_price
    )
    return "total_volatile_asset_pcv_value", total_volatile_asset_pcv_value


def update_total_pcv_value(
    params, substep, state_history, previous_state, policy_input
):
    """
    Update total volatile asset PCV value.
...
def update_stable_backing_ratio(
    params, substep, state_history, previous_state, policy_input
):
    """
    ...
    stable_backing_ratio = total_stable_asset_pcv_value / (
        total_volatile_asset_pcv_value + total_stable_asset_pcv_value
    )
    return "stable_backing_ratio", stable_backing_ratio


def update_collateralization_ratio(
    params, substep, state_history, previous_state, policy_input
):
    """
    Update PCV stable backing value.
