...
def policy_yield_accrual(params: Parameters, substep, state_history, previous_state) -> dict[str: PCVDeposit]:
...
def policy_reinvest_yield(params: Parameters, substep, state_history, previous_state) -> dict[str: PCVDeposit]:
