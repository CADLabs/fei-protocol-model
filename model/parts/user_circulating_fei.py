def update_total_user_circulating_fei(params, substep, state_history, previous_state, policy_input):
    """
...
def update_protocol_equity(params, substep, state_history, previous_state, policy_input):
    """
    Update PCV stable backing value.
    """
